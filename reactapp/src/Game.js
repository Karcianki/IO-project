            ...
            <div className="page_game">
                ...
                <div className="opcje">
                    <div className = "host" id="start">
                       {player_number == 0 && isStarted == false && <button onClick={setStarted} className="game_button poker_button" type="submit" id="start">Start</button>}
                    </div>
                    <div className = "host_next" id="next">
                    {player_number == 0 && isInTurn == false && <button onClick={setTurn} className="game_button poker_button" type="submit" id="next">Next</button>}
                    </div>
